<?php
	class Product_bestsale extends MY_Controller{
		...
		public function index(){
			...
			$config['total_rows'] 	= $this->mproduct->count_all_bestsale();
			...
			$data['list_pro'] 		= $this->mproduct->list_pro_bestsale($config['per_page'],$start);
			$this->debug($get_setup['set_count_pro']);
