...
class cloud extends Student
{
    ...
    {
            $this->form_validation->set_rules("label1", "label1", "required|xss_clean");
            $this->form_validation->set_rules("label2", "label2", "trim|required|xss_clean");
            $this->form_validation->set_rules("label3", "label3", "trim|required|xss_clean");
            $this->form_validation->set_rules("label4", "label4", "trim|required|xss_clean");
            $this->form_validation->set_rules("label5", "label5", "trim|required|xss_clean");
