<div class="sidebar_header" style="position: fixed; top: 0px;">
   <div class="container andy-container" style="text-align: right; ">
        ...
        <a class="vector_icon" title="Google+" href="https://plus.google.com/u/0/+MinhQu%C3%A2n004/posts" target="_blank">
  ...
  <div class="row">
    <div class="andy-responsive">
      ...
      <div class="social-share">
          ...
          <a class="facebook" title="Twitter" href="https://twitter.com/intent/tweet?url=<?=urlencode(base_url(uri_string()))?>&title=<?= isset($title) ?  urlencode($title) : ''; ?>" target="_blank">
            <i class="fa fa-twitter"></i>
          </a>
          <a class="facebook" title="Google" href="https://plus.google.com/share?url=<?=urlencode(base_url(uri_string()))?>&title=<?= isset($title) ?  urlencode($title) : ''; ?>" target="_blank">
            <i class="fa fa-google-plus fa-2x"></i>
          </a>
      </div>
...
<script>(function(d, s, id) {
                         var js, fjs = d.getElementsByTagName(s)[0];
                           ...
                           js = d.createElement(s); js.id = id;
                                 js.src = "//connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.5&appId=1300966243262691";
