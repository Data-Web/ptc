	...
	<div class="page-content">
		<div class="page-breadcrumbs">
			<ul>
				...
				<li>
					<a href="<?php echo $lang_page == '1' ? base_url("tuyen-dung/".$infoItem['url_rewrite']."-".$infoItem['id']) : base_url("recruit/".$infoItem['url_rewrite']."-".$infoItem['id']) ?>" title="<?php echo $infoItem['title'] ?>"><?php echo $infoItem['title'] ?></a>
				</li>
			</ul>
		</div>
		<div class="page-wrapper">
			...
			<div class="page-body">
                ...
                <div class='comment-facebook'>
                   <div id="fb-root"></div>
                       <div class="fb-comments" data-href="<?php echo base_url(uri_string()); ?>" data-numposts="10" data-width="100%"></div>
