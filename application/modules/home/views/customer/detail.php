	...
	<div class="page-content">
		<div class="page-breadcrumbs">
			<ul>
				...
				<li>
					<a href="<?php echo $lang_page == '1' ? base_url("khach-hang/".$infoItem['url_rewrite']."-".$infoItem['id']) : base_url("customer/".$infoItem['url_rewrite']."-".$infoItem['id']) ?>" title="<?php echo $infoItem['title'] ?>">
		...
		<h3 style="display: none;"><?php echo $infoItem['title']; ?></h3>
	</div>
</div>