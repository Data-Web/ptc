<div class="paddings">
  <form method="post" action="" method="post" enctype="multipart/form-data" name="account_form">
    ...
    <table id="tb-list" class="form-table" border="1" bordercolor="#CCCCCC">
      <tbody>
        ...
        <tr>
          <td>Meta Keywords</td>
          <td>
            <textarea class="seo_info" name="seo_keyword"><?php echo isset($post) && $post['seo_keyword'] ? $post['seo_keyword']  : $this->input->post('seo_keyword'); ?></textarea>
          </td>
        </tr>
        <tr>
