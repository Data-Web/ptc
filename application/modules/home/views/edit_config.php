    ...
    <table id="tb-list" border="1" bordercolor="#CCCCCC">
      <tbody>
        ...
        <tr style="background:none !important;color:inherit">
          <td>Miền bắc</td>
          <td>
            <input type="text" value="<?php echo isset($config['mienbac']) ? $config['mienbac'] : ''; ?>" size="60" name="mienbac">
          </td>
        </tr>
        ...
        <tr style="background:none !important;color:inherit">
          <td>Kinh doanh</td>
          <td>
            <input type="text" value="<?php echo isset($config['miennam']) ? $config['miennam'] : ''; ?>" size="60" name="miennam">
          </td>
        </tr>
        ...
        <tr style="background:none !important;color:inherit">
          <td>Kỹ thuật</td>
          <td>
            <input type="text" value="<?php echo isset($config['danang']) ? $config['danang'] : ''; ?>" size="60" name="danang">
          </td>
        </tr>
