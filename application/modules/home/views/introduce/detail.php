	...
	<div class="page-content">
		<div class="page-breadcrumbs">
			<ul>
				...
				<li>
					<a href="<?php echo $lang_page == '1' ? base_url("gioi-thieu/".$infoItem['url_rewrite']."-".$infoItem['id']) : base_url("introduce/".$infoItem['url_rewrite']."-".$infoItem['id']) ?>" title="<?php echo $infoItem['title'] ?>">
