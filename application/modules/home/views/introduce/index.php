	...
	<div class="page-content">
			...
			<ul>
				...
				<li>
					<?php 
						if ($lang_page == '1') {
					?>
					<a title="Giới thiệu" href="<?php echo base_url('gioi-thieu') ?>">Giới thiệu</a>
					<?php } else { ?>
					<a title="Introduce" href="<?php echo base_url('introduce') ?>">Introduce</a>
					<?php } ?>
				</li>
			</ul>
		</div>
		<div class="page-wrapper">
			<div class="page-title">
				<h1><?php echo $lang_page == '1' ? 'Giới thiệu chung' : 'Introduce' ?></h1>
			</div>
			<div class="page-body">
				<?php
					if (!empty($listIntroduce)) {
						foreach ($listIntroduce as $v) {
				?>
				...
				<div class="col-md-12 col-sm-12 col-xs-12 full-xs">
					<h3><?php echo $lang_page == '1' ? 'Không tồn tại giới thiệu nào' : 'Introduce does not exist yet' ?></h3>
				</div>
				<?php } ?>
