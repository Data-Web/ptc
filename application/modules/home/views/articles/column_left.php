<div class="column_left">
      <div id="cat_left">
        <ul>
        	<li class=""><a href="<?php echo base_url()."/tin-tuc/";?>" class="root">Tin Tức</a></li>
	        <?php
			...
			?>
			  ...
			  ?>
              <li class=""><a href="<?php echo base_url()."huong-dan-hoi-dap/ac221.html";?>" class="root">Hướng dẫn &amp; hỏi đáp</a></li>
        </ul>
