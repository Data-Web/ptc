<form method="post" action="" name="account_form" enctype="multipart/form-data"> 
    <div class="group">
        ...
        <div class="infobasic">
            ...
            <select id="bachnx_change" name="pro_lang">
                <option value="">Chọn ngôn ngữ</option>
                <option value="1" <?php echo $this->input->post('pro_lang') == 1 ? 'selected' : ''; ?>>Tiếng Việt</option>
                <option value="2" <?php echo $this->input->post('pro_lang') == 2 ? 'selected' : ''; ?>>Tiếng Anh</option>
            </select>
            <?php echo form_error('pro_lang'); ?>
