    ...
    class MY_Controller extends CI_Controller{
        ...
        public function __construct(){
            ...
            if($this->router->fetch_class() == 'category') {
                ...
                $categoryDetail = $this->mcategory->getOnce($idCategory);
                ...
                if (isset($subCategories) && $subCategories != null) {
                    ...
                    $subCategories = $this->mcategory->getAllSubCategories($data['lang_page'], $categoryDetail['cate_id_parent']);
                    if (!empty($subCategories)) {
                        $this->_listSubCategory = $subCategories;
                        $aObj = new andyrecursive;
                        $this->_listSubCategory = $aObj->recursiveMenu($this->_listSubCategory, 'cate_id', 'cate_id_parent', $categoryDetail['cate_id_parent']);
                    }
                }
        ...
        public function newsList($langPage)
        {
            return $this->mnews->getAll($langPage);
        }
