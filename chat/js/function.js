...
function upstyle(element){
	if (element == 'b')
	{
		if (document.getElementById('upb').className == 'sbutton')
			document.getElementById('upb').className = 'sbutton_active';
		else
			document.getElementById('upb').className = 'sbutton';
		
	}
	else if (element == 'i')
	{
		if (document.getElementById('upi').className == 'sbutton')
			document.getElementById('upi').className = 'sbutton_active';
		else
			document.getElementById('upi').className = 'sbutton';
		
	}
	else if (element == 'u')
	{
		if (document.getElementById('upu').className == 'sbutton')
			document.getElementById('upu').className = 'sbutton_active';
		else
			document.getElementById('upu').className = 'sbutton';	
	}
}
function check_form()
{
...
function smiliepopup(){
	window.open("?param=smilies", "", "location=no,scrollbars=yes,width=500,height=500");
}
...
function send_chat(){
	...
	var upb = (document.getElementById('upb').className == 'sbutton_active') ? 'B' : '';
	var upi = (document.getElementById('upi').className == 'sbutton_active') ? 'I' : '';
	var upu = (document.getElementById('upu').className == 'sbutton_active') ? 'U' : '';		
...
function reg_submit(user,pass){	
	...
	ajax.send("index.php?param=sign&act=up",param);	
...
function log_check(){
	...
	ajax.send("index.php?param=sign&act=in",param);	
	document.getElementById('main').innerHTML = 'Loading...';	
