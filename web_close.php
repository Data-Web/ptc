  ...
  <div id='container'>
    <div id='login'>
      ...
      <div>
        ...
        <span class="default-text" style="margin-bottom:0px;">Website đang bảo trì &amp; nâng cấp, Quý khách vui lòng liên hệ!
        <br /> Mr.Tuấn: 0974.844.222
        <br />Địa chỉ: 235 Phố Đức Tâm 1 TT Văn Quan Huyện Văn Quan Lạng Sơn
        </span>
        <br />
        </p>
